...
public class BniDebitTransferRequest extends BniRequest {

	public BniDebitTransferRequest() {
		super(200);
	}
	...
	public void setProcessingCode(String processingCode) {
		...
		if (getProcessingCode() != 401000 && getProcessingCode() != 402000)
	...
	public void setPrivateData62(String data) {
		if (data.length() != 32)
			throw new IllegalArgumentException("Must be 32 chars PrivateData62: " + data);
		tm.getIsomsg().addDE(new DataElement(62, data).setPacked(true).setL4(EncodeType.BCD).setLnVal(16));
	}
	
	public void setPrivateData63(String data) {
		if (data.length() != 40)
			throw new IllegalArgumentException("Must be 40 chars PrivateData63: " + data);
		tm.getIsomsg().addDE(new DataElement(63, data).setPacked(true).setL4(EncodeType.BCD).setLnVal(20));
	}
}
