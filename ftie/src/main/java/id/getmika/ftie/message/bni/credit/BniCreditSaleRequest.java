...
public class BniCreditSaleRequest extends BniRequest {
	
	public BniCreditSaleRequest() {
		super(200);
	...
	public void setPrivateData62(String privateData62) {
		tm.getIsomsg().addDE(new DataElement(62, privateData62).setL4(EncodeType.BCD));	
	}
}
