...
public final class EmvUtil {
    ...
    public static Map<String, String> getConfig(String country) {
        ...
        if (COUNTRY_RUSSIA.equalsIgnoreCase(country)) {
            ...
            map.put("5F2A", "0356");
            map.put("5F36", "02");
        } else if (COUNTRY_INDONESIA.equalsIgnoreCase(country)) {
            map.put("countryCode", "0360");
            map.put("capability", "E0F8C8");
            map.put("5F2A", "0360");
            map.put("5F36", "00");
        }
    ...
    public static void initKey() {
        try {
            SecurityOptV2 mSecurityOptV2 = MikaSdk.mSecurityOptV2;
            ...
            LogUtil.e(TAG, "save KEK result:" + result);
            if (result != 0) {
                LogUtil.e(TAG, "save KEK fail");
                return;
            }
            ...
            LogUtil.e(TAG, "save TMK result:" + result);
            if (result != 0) {
                LogUtil.e(TAG, "save TMK fail");
                return;
            }
            ...
            LogUtil.e(TAG, "save PIK result:" + result);
            if (result != 0) {
                LogUtil.e(TAG, "save PIK fail");
                return;
            }
            ...
            LogUtil.e(TAG, "save MAK result:" + result);
            if (result != 0) {
                LogUtil.e(TAG, "save MAK fail");
                return;
            }
            ...
            LogUtil.e(TAG, "save TDK result:" + result);
            if (result != 0) {
                LogUtil.e(TAG, "save TDK fail");
                return;
            }

            LogUtil.e(TAG, "init key success");
        } catch (Exception e) {
            e.printStackTrace();
            LogUtil.e(TAG, "init key fail");
        }
    }
    ...
    public static void initAidAndRid() {
        try {
            EMVOptV2 emvOptV2 = MikaSdk.mEMVOptV2;
            //Normal AIDs
    ...
    public static void setTerminalParam(Map<String, String> map) {
        try {
            ...
            LogUtil.e(TAG, "setTerminalParam result:" + result);
        } catch (Exception e) {
            e.printStackTrace();
            LogUtil.e(TAG, "setTerminalParam fail");
        }
    }
