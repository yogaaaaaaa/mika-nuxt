...
class TransactionAdapter(
    ...
    private val onTransactionSelected: (Transaction, View) -> Unit
    ...
    fun addData(transactions: List<Transaction>, headers: List<HeaderTransaction>) {
    ...
    inner class TransactionViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(
            ...
            listener: (Transaction, View) -> Unit
        ) = with(itemView) {
